...
export default function SDIVol1Reference() {
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-white light:text-gray-900">System Design Interview — Book Notes</h1>
      ...
      {/* Volume 1 */}
      <h2 className="text-xl font-bold text-white light:text-gray-900 border-b border-blue-900/50 light:border-blue-200 pb-2">
      ...
      {/* Volume 2 */}
      <h2 className="text-xl font-bold text-white light:text-gray-900 border-b border-blue-900/50 light:border-blue-200 pb-2 mt-12">
