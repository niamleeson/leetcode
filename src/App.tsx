...
import NeetCode150 from './components/NeetCode150';
import NeetCodeBlind75 from './components/NeetCodeBlind75';
    ...
    <div className="relative min-h-screen bg-gray-950">
      ...
      <main className="p-2 md:p-6 pt-14 overflow-y-auto max-w-5xl mx-auto">
        <Routes>
          ...
          <Route path="/neetcode150" element={<NeetCode150 />} />
          <Route path="/blind75" element={<NeetCodeBlind75 />} />
          ...
          <Route path="/train/dsa" element={<StudyMode source="dsa" />} />
